...
- SQLite 모델과 service layer를 추가했습니다.
...
docs: add technology decision document
...
| Backend | Flask REST API, Provider Adapter, 실행 로직 |
| Database | SQLite 모델, 저장 구조, 히스토리 관리 |
| DevOps | Docker, GitHub Actions, 실행 가이드 |
